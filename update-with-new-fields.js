// Update all boosters with ingredient lists and benefits (after columns are added)
...
async function updateWithNewFields() {
  try {
    console.log('🚀 Starting update with ingredient lists and benefits...')
    ...
    console.log(`   📝 Descriptions updated with clinical study results`)
    console.log(`   🧪 Ingredient lists added with CAS numbers and technical details`)
    console.log(`   🌟 Benefits added with specific skin care actions`)
...
updateWithNewFields()
  .then(() => {
    console.log('\n✨ Complete booster update finished!')
    process.exit(0)
  })
  .catch(error => {
